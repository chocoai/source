 ...
 * @version 2018-05-24
 */
@Table(name="${_prefix}am_lib_iodetails", alias="a", columns={
		...
		@Column(name="sign", attrName="sign", label="进出标志", comment="进出标志(0是进，1是出)"),
...
public class AmLibIodetails extends DataEntity<AmLibIodetails> {
	
	private static final long serialVersionUID = 1L;
	private Date operationDate;		// 操作时间
	private String operationBy;		// 操作人
	private String sign;		// 进出标志(0是进，1是出)
	...
	public AmLibIodetails() {
		this(null);
	}

	public AmLibIodetails(String id){
		super(id);
	}
