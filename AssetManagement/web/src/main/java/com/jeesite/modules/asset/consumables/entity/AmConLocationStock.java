...
@Table(name="${_prefix}am_con_location_stock", alias="a", columns={
	...
	}, orderBy="a.warehouse_code DESC, a.consumables_code DESC, a.location_code DESC"
)
public class AmConLocationStock extends DataEntity<AmConLocationStock> {
	...
	public AmConLocationStock() {
		this(null,null,null);
	}

	public AmConLocationStock(String warehouseCode, String consumablesCode, String locationCode){
