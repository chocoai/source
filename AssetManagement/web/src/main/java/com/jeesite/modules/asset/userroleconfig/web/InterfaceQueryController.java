...
//import com.jeesite.modules.asset.userroleconfig.entity.InterfaceQueryData;
//import com.jeesite.modules.asset.userroleconfig.entity.UserDataPermission;
//import com.jeesite.modules.asset.userroleconfig.service.InterfaceInfoService;
//import com.jeesite.modules.asset.userroleconfig.service.InterfaceQueryService;
//import com.jeesite.modules.asset.userroleconfig.service.UserDataPermissionService;
...
//                    if (stitching == null || stitching.length() <= 0) {                                   //默认用and拼接
//
//                        interfaceSQL += param + " " + interfaceQuerylist.get(j).getSymbol() + " " + value;
...
//            userDataPermission3.setInterfaceSql(interfaceSQL);
