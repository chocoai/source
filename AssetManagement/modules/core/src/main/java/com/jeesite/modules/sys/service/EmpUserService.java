...
//		userService.updatePassword(user.getUserCode(), employee.getPasWord());
		if (!"".equals(employee.getPasWord()) && employee.getPasWord() != null) {
			user.setPassword(UserService.encryptPassword(employee.getPasWord()));
		}
