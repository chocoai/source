...
public class EmployeeService extends CrudService<EmployeeDao, Employee> {
	...
	@Transactional
	public int synchronizeSysUserInfo(String oldLoginCode,String loginCode, String passWord) {
		return employeePostDao.synchronizeSysUserInfo(oldLoginCode,loginCode,passWord);
	}
}