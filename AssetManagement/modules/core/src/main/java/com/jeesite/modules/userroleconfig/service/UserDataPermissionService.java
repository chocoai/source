...
public class UserDataPermissionService extends CrudService<UserDataPermissionDao, UserDataPermission> {
	...
	public List<UserDataPermission> getListByUserCodeAndIntUrl(String userCode,String interSql) {
		List<UserDataPermission> userDataPermission=userDataPermissionDao.getListByUserCodeAndIntUrl(userCode,interSql);
		return  userDataPermission;
	}
}